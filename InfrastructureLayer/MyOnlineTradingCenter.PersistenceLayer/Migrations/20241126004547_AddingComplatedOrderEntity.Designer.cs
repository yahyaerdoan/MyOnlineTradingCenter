...
namespace MyOnlineTradingCenter.PersistenceLayer.Migrations
{
    ...
    [Migration("20241126004547_AddingComplatedOrderEntity")]
    partial class AddingComplatedOrderEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyOnlineTradingCenter.DomainLayer.Concretions.Entities.Entities.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyOnlineTradingCenter.DomainLayer.Concretions.Entities.Entities.CompletedOrder", b =>
                {
                    b.HasOne("MyOnlineTradingCenter.DomainLayer.Concretions.Entities.Entities.Order", "Order")
                        ...
                        .HasForeignKey("MyOnlineTradingCenter.DomainLayer.Concretions.Entities.Entities.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
